...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="dlvName" name="dlvName" type="text" placeholder="' . $this->vm->getDeliveryname() . '" disabled>
    </div>
    <div class="form-group">
        <label for="dlvStreet">Street and number</label>
        <input type="text" class="form-control" id="dlvStreet" name="dlvStreet" placeholder="Where shall we deliver?">
    </div>
    <div class="form-group">
        <label for="dlvZip">Zipcode</label>
        <input type="text" maxlength="4" class="form-control" id="dlvZipcode" name="dlvZipcode">
    </div>
    <div class="form-group">
        <label for="dlvCity">City</label>
        <input type="text" class="form-control" id="dlvCity" name="dlvCity">
    </div>
    <div class="form-group">
        <div class="checkbox">
            <label>
    ...
    <div id="invAddr" class="hide">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="invStreet" name="invStreet" placeholder="Where can we send the bill?">
        </div>
        <div class="form-group">
            <label for="invZip">Zipcode</label>
            <input type="text" maxlength="4" class="form-control" id="invZipcode" name="invZipcode">
        </div>
        <div class="form-group">
            <label for="invCity">City</label>
            <input type="text" class="form-control" id="invCity" name="invCity">
        </div>
    </div>
    <div class="form-group">
        <label for="dlvMethod">Delivery method</label>
        <select class="form-control" id="dlvMethod" name="dlvMethod">
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="invMethod" name="invMethod">
